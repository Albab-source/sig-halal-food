...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Find Your Favorite Restaurant</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="<?=base_url()?>">Home</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Maps</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div id="maps" class="container-xxl py-5">
        <div class="container">
            <div class="justify-content-center">
                    <iframe src="<?=base_url()?>/home" width="100%" height="1000" style="border: none; min-height: 600px; max-height: 100vh; border-radius: 8px;"></iframe>
            </div>
        </div>
    </div>
    <!-- Maps End -->
